...
struct ReverseMultiTransformer : public Visitor<T>
{
    ...
    VisitorResult<T> visit(std::shared_ptr<Sin<T>> op) { return for_side == op->get_x() ? std::vector<std::shared_ptr<MathOp<T>>> { asin(from) } : std::vector<std::shared_ptr<MathOp<T>>> { }; }
    VisitorResult<T> visit(std::shared_ptr<ASin<T>> op) { return for_side == op->get_x() ? std::vector<std::shared_ptr<MathOp<T>>> { sin(from) } : std::vector<std::shared_ptr<MathOp<T>>> { }; }
    VisitorResult<T> visit(std::shared_ptr<Cos<T>> op) { return for_side == op->get_x() ? std::vector<std::shared_ptr<MathOp<T>>> { acos(from) } : std::vector<std::shared_ptr<MathOp<T>>> { }; }
    VisitorResult<T> visit(std::shared_ptr<ACos<T>> op) { return for_side == op->get_x() ? std::vector<std::shared_ptr<MathOp<T>>> { cos(from) } : std::vector<std::shared_ptr<MathOp<T>>> { }; }
    VisitorResult<T> visit(std::shared_ptr<Tan<T>> op) { return for_side == op->get_x() ? std::vector<std::shared_ptr<MathOp<T>>> { atan(from) } : std::vector<std::shared_ptr<MathOp<T>>> { }; }
    VisitorResult<T> visit(std::shared_ptr<ATan<T>> op) { return for_side == op->get_x() ? std::vector<std::shared_ptr<MathOp<T>>> { tan(from) } : std::vector<std::shared_ptr<MathOp<T>>> { }; }
    VisitorResult<T> visit(std::shared_ptr<Sinh<T>> op) { return for_side == op->get_x() ? std::vector<std::shared_ptr<MathOp<T>>> { asinh(from) } : std::vector<std::shared_ptr<MathOp<T>>> { }; }
    VisitorResult<T> visit(std::shared_ptr<ASinh<T>> op) { return for_side == op->get_x() ? std::vector<std::shared_ptr<MathOp<T>>> { sinh(from) } : std::vector<std::shared_ptr<MathOp<T>>> { }; }
    VisitorResult<T> visit(std::shared_ptr<Cosh<T>> op) { return for_side == op->get_x() ? std::vector<std::shared_ptr<MathOp<T>>> { acosh(from) } : std::vector<std::shared_ptr<MathOp<T>>> { }; }
    VisitorResult<T> visit(std::shared_ptr<ACosh<T>> op) { return for_side == op->get_x() ? std::vector<std::shared_ptr<MathOp<T>>> { cosh(from) } : std::vector<std::shared_ptr<MathOp<T>>> { }; }
    VisitorResult<T> visit(std::shared_ptr<Tanh<T>> op) { return for_side == op->get_x() ? std::vector<std::shared_ptr<MathOp<T>>> { atanh(from) } : std::vector<std::shared_ptr<MathOp<T>>> { }; }
    VisitorResult<T> visit(std::shared_ptr<ATanh<T>> op) { return for_side == op->get_x() ? std::vector<std::shared_ptr<MathOp<T>>> { tanh(from) } : std::vector<std::shared_ptr<MathOp<T>>> { }; }
